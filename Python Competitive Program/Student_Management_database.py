...
class Student:
    ...
    def add_students(self):
        con=pymysql.connect(host="localhost",user="root",password="Mishra@21",database="student1")          # create database name on phpmyadmin = smd
        cur=con.cursor()
        cur.execute("insert into rkm values(%s,%s,%s,%s,%s,%s,%s)",(self.Roll_No_Var.get(),
                                                                         self.name_Var.get(),
                                                                         self.email_Var.get(),
                                                                         self.gender_Var.get(),
